...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{images/3A1.png}
    \caption{Resposta Problema 3 A.1}
    \label{fig:3A1.png}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{images/3A2_codigo.png}
    \caption{Saída Problema 3 A.2}
    \label{fig:3A2_codigo.png}
\end{figure}
