...
Logo,
\[
\boxed{E\approx 1{,}028021589\ \text{rad}}
...
E-e\sin(E)
&\approx 1{,}0280215886
-0{,}967\sin(1{,}0280215886)\\
&\approx 0{,}2000000000=M.
\end{align*}
...
f'(E)=1-e\cos E,
\]
para $E\approx 0$ temos $\cos(E)\approx 1$, logo
\[
f'(E)\approx 1-e.
\]
...
\frac{f(E)}{f'(E)}
\]
pode tornar-se grande, e o método de Newton pode exigir mais iterações.
Portanto, o esforço computacional aumenta à medida que $e\to 1$.

\subsection*{E.3}

Para $e=0{,}99$ e $M=0{,}01$, tomamos
\[
E_0=M+e\sin(M).
\]
...
Após 7 iterações,
\[
\boxed{E\approx 0{,}3422703165}.
\]

Comparando os chutes iniciais:
\begin{center}
\begin{tabular}{lc}
\hline
\textbf{Chute inicial} & \textbf{Iterações}\\ \hline
$E_0=M=0{,}01$ & 7\\
$E_0=M+e\sin(M)\approx 0{,}019899835$ & 7\\ \hline
\end{tabular}
\end{center}

Neste caso, o novo chute não reduziu o número de iterações.

\subsection*{E.4}

Para $e=0{,}99$ e $M=0{,}01$, temos
\[
...
Logo, pelo Teorema de Bolzano, existe uma raiz no intervalo.
Além disso,
\[
f'(E)=1-0{,}99\cos E>0,
\]
...
Aplicando a bissecção com $\varepsilon=10^{-6}$:
\[
\boxed{E\approx 0{,}3422702123\ \text{rad}}
\qquad\text{em 22 iterações.}
\]
...
\begin{tabular}{lc}
\hline
\textbf{Método} & \textbf{Iterações}\\ \hline
Newton & 7\\
Bissecção & 22\\ \hline
\end{tabular}
\end{center}

Assim, Newton é mais indicado quando a velocidade computacional é prioritária.
